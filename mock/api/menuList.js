  ...
  Mock.mock('api/test/menuList', 'post', {
    ...
    data: {
      list: [
       ...
       { id: 2, menuParentId: 0, sortNo: 2, menuPath: '/test/2', menuName: 'aa项目', menuIcon: 'el-icon-s-tools' },
       ...
       { id: 4, menuParentId: 2, sortNo: 2, menuPath: '/test/5', menuName: 'dd项目', menuIcon: 'el-icon-goods' },
